...
namespace PozyxPositioner.Framework
{
    ...
    public class Tag
    {
        ...
        public Tag(string ID, int RefreshRate)
        {
            ...
            _calibrated = false;
            _prevIndx = 0;
            SimEnvironment.Instance.newTag(this);
        }
    ...
    public class SimObject
    {
        ...
        public SimObject()
        {
            ...
            _posoffset = new PozyxVector(0, 0, 0);
            O_Vector = new PozyxVector(0, 0, 0);
        ...
        /// <summary>
        /// PozyxVector: The Orientation of the current Simobject in radians in a right handed coordinate system.
        /// </summary>
        ...
        private async void CalibrateAsync(SimEnvironment S)
        {
        ...
        private async void CalibrateAsync(SimEnvironment S, float xpos, float ypos, float zpos)
        {
            CalibrateAsync(S);
            PozyxVector P = new PozyxVector(xpos, ypos, zpos);
        ...
        private async void CalibrateAsync(SimEnvironment S, float xpos, float ypos, float zpos, float scale)
        {
            CalibrateAsync(S);
            PozyxVector P = new PozyxVector(xpos, ypos, zpos);
            _scale = scale;
